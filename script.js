...
function restartGame() {
    ...
    // Сбрасываем счетчик шестерок, если он существует
    if (window.DiceSequenceHandler && typeof window.DiceSequenceHandler.reset === 'function') {
        console.log("Сбрасываем счетчик и последовательность шестерок");
        window.DiceSequenceHandler.reset();
    }
